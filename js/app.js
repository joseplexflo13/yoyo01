...
// ---------- Subtabs de nivel superior (Tareas / Help) ----------
...
function switchSubtab(name) {
  document.getElementById('subtab-panel-tareas').classList.toggle('hidden', name !== 'tareas');
  document.getElementById('subtab-panel-help').classList.toggle('hidden', name !== 'help');

  const tareasBtn = document.getElementById('subtab-btn-tareas');
  const helpBtn = document.getElementById('subtab-btn-help');
  tareasBtn.classList.toggle('subtab-btn-active', name === 'tareas');
  tareasBtn.setAttribute('aria-selected', String(name === 'tareas'));
  helpBtn.classList.toggle('subtab-btn-active', name === 'help');
  helpBtn.setAttribute('aria-selected', String(name === 'help'));
}

// ---------- Tarjetas desplegables del subtab "Help" ----------
function initHelpCards() {
  document.querySelectorAll('[data-help-toggle]').forEach(header => {
